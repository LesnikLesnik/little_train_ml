...
- Предполагается что в среде где применяется модель - больных депрессией порядка 60%
- Желаемые показатели по классу "депрессия" в этом случае:
- **Recall**: ≥ 90%
- **Precision**: ≥ 75%

#### Сценарий 2: Оптимистичный (10% больных)
 Предполагается что в среде где применяется модель - больных депрессией порядка 10%
- Желаемые показатели по классу "депрессия" в этом случае:
- **Recall**: ≥ 90%
- **Precision**: ≥ 20%
